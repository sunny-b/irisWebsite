	...
	<body class="home colorNormal">
			      ...
			      <div class="row-fluid">
			        <div class="col-lg-12  col-md-12 col-sm-12">
			            ...
			            <div class="carousel-inner" role="listbox">
			                ...
			                <img class="scale4" src="img/posters/35_img_gallery_tweens.jpg" alt="Responsive image">
			              </div>
			              ...
			              <div class="accolades2">
												<a class="prev-next" id="next2" href="g.php">Next:<br>G Poster</a>
												
												<br>
												
													<a class="prev-next" id="prev2" href="fabulous.php">Previous:<br>Fabulous</a>
										</div>
		...
		<div class="wrapper">
			<div class="content">	
				<div class="about">
				<h3>Tweens</h3>
				<h4>Type / Visual / Lettering Design</h4>
				
				<p>Tweens is a punk rock band from Cincinnati, Ohio. This poster paid homage to the band's edgy style and their love of scrapbooking. The style of lettering I used in this poster is a script typeface that is in production called Scotch script.</p>
				
			</div>	
			<div class="content-break"></div>
			<div class="mobileNP">
				<a class="mobileNepr" href="fabulous.php">Previous:<br>Fabulous</a>
				<a class="mobileNepr" href="g.php">Next:<br>G Poster</a>
			</div>
			<div class="accolades">
				<a class="next-prev" id="next" href="g.php">Next:<br>G Poster</a>
				
				<br>
				
					<a class="next-prev" id="prev" href="fabulous.php">Previous:<br>Fabulous</a>
			</div>
		</div>
