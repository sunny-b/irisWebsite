...
$(window).load(function(){$(".fixedFooter, .nav, #instaIcon, #mailto,.appearing").delay().animate({opacity:1},250),$(".gallery-content").animate({opacity:"1",marginTop:"100"},250),$(".moving").animate({opacity:"1",top:"0"},350)}),$(document).ready(function(){$(".pullright .toggle").click(function(){return $(".pullright ul").slideToggle(),!1})}),$hamburger=$(".hamburger"),$("header").show(),$hamburger.click(function(){$("div.bottomBorder").addClass("effect"),$("#downArrow").hide(),$(".overlay-close").click(function(){$("header, .wrapper").removeClass("effect"),$("#downArrow").show(250),$("div.bottomBorder").removeClass("effect")})}),$(document).ready(function(){}),$(window).scroll(function(){$(window).scrollTop()>10&&$(window).innerWidth()<=641?$(".bottomBorder").fadeIn():$(window).scrollTop()>20&&$(window).innerWidth()>=641?$(".bottomBorder").fadeIn():$(".bottomBorder").fadeOut()}),$(document).ready(function(){function e(e){e.preventDefault()}$(".nav .name a,.overlay-menu a,.wrapper .content .about a,footer .social-links ul li a,a.emailAdd,a.next-prev,a.prev-next,.middleNav ul li a").on("click touchend",function(e){var o=$(this),t=o.attr("href");window.location=t}),$(".hamburger").click(function(){document.addEventListener("touchmove",e,!0)}),$(".overlay-close").click(function(){document.removeEventListener("touchmove",e,!0)})}),navigator.userAgent.match(/Version\/[\d\.]+.*Safari/)?$(".overlay-menu a.work, .grid-item a:not(.different),a#hi,a#aboutIris").click(function(e){var o=$(this).attr("href");e.preventDefault(),$("body").animate({top:"110%",opacity:"0"},200),$("#sticker").animate({opacity:0},200),setTimeout(function(){window.location=o},100),$("body").delay(500).animate({top:"0",opacity:"1"},500),$("#sticker").delay(500).animate({opacity:1},500)}):$(".overlay-menu a.work, .grid-item a:not(.different),a#hi,a#aboutIris").click(function(e){var o=$(this).attr("href");e.preventDefault(),$("body").animate({top:"110%",opacity:"0"},200),$("#sticker").animate({opacity:0},200),setTimeout(function(){window.location=o},100)}),$(document).on("ready",function(){var e=$(".grid").isotope({itemSelector:".grid-item",layoutMode:"masonry",masonry:{columnWidth:".grid-sizer",gutter:3}});e.imagesLoaded().progress(function(){e.isotope("layout")}),$(".middleNav a, .nav .name a").click(function(){$(".middleNav ul li a").hasClass("selected")?($(".middleNav ul li a").removeClass("selected"),$(this).addClass("selected")):$(this).addClass("selected");var o=$(this).attr("data-filter");e.isotope({filter:o})})}),$(".grid-item .cover").hide(),$(".grid-item .follow").hide(),$(".hoverimg img").mouseenter(function(){$(".grid-item .cover, .grid-item .follow").show();var e=document.querySelector(".grid-item:hover img").clientWidth,o=document.querySelector(".grid-item:hover img").clientHeight,t=document.querySelector(".hoverimg:hover .follow").clientHeight,i=document.querySelector(".hoverimg:hover .follow").clientWidth;$(".grid .hoverimg:hover .cover").css({width:e,height:o,top:0,left:0}),$(".grid .hoverimg:hover .follow").css({left:e/2-i/2,top:o/2-t/2}),$(".hoverimg").mouseleave(function(){$(".grid-item .cover, .grid-item .follow").hide(),$(".grid .hoverimg:hover .cover").css({width:null,height:null,top:null,left:null})})});